...
UPDATE products SET total_quantity = stock_quantity + reserved_quantity;
...
('WELCOME10', 'Приветственная скидка', 'percentage', 10, NOW(), '2026-12-31'),
('SUMMER2025', 'Летняя распродажа', 'fixed_amount', 5000, NOW(), '2026-08-31');
